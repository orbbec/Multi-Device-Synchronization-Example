Building a Multi-Machine Synchronization System for 8 Femto Mega RGBD Linux Systems Guide 
...
./MultiCameraSync 
```
# 6. System Effect Demonstration
## 6.1  8-Camera Femto Mega RGBD Synchronized Preview Effect
![display](res/gif/display.gif)
# 7. System Product List
## 7.1 System Project and Material Description
